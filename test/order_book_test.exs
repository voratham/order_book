defmodule OrderBookTest do
  ...
  test "should return result correctly with input 5" do
    ...
    assert OrderBook.main(input) ==
             {:ok, convertJSONToStruct(~s({"buy":[{"price":90.394,"volume":20}],"sell":[]}))}
  end
  ...
  test "should return result correctly with input 7" do
    ...
    assert OrderBook.main(input) ==
             {:ok,
              convertJSONToStruct(
                ~s({"buy":[{"price":90.394,"volume":20}],"sell":[{"price":100.003,"volume":20}]})
              )}
  end

  test "should return error when invalid input case 1" do
    input = ''
  ...
  test "should return error when invalid input case 2" do
    input = '{}'
